/* empty css                      */import{a as d,S as f,i}from"./assets/vendor-DA0uMjGz.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const n of t.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&o(n)}).observe(document,{childList:!0,subtree:!0});function a(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function o(e){if(e.ep)return;e.ep=!0;const t=a(e);fetch(e.href,t)}})();function m(r){const s="https://pixabay.com",a="52284043-e07dc2496c8ab93aaf5c906d1",o="/api/",e={key:a,q:r,image_type:"photo",orientation:"horizontal",safesearch:"true"};return d.get(`${s}${o}`,{params:e}).then(t=>t.data.hits)}const h=new f(".gallery a",{captionsData:"alt",captionDelay:250}),l=document.querySelector(".gallery"),c=document.querySelector(".loader");function g(r){return r.map(({webformatURL:s,largeImageURL:a,tags:o,likes:e,views:t,comments:n,downloads:p})=>`<li class="photo-item">
